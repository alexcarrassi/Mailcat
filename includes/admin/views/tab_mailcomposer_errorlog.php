                                ...
                                <div class="rectification_form_id_fields">
                                    ...
                                    <?php if(isset($id_error['data']['valid_ids'])):
                                        foreach($id_error['data']['valid_ids'] as $key => $value) : ?>
                                            <div class="errorlog_row">
                                                ...
                                                <input name="<?php echo $key; ?>" value="<?php echo $value; ?>" placeholder="<?php echo __("Enter id value for ") . $key?>" class="errorlog_report_result" required/>
                                            </div>
                                    ...
                                    <?php if(isset($id_error['data']['invalid_ids'])):
                                        foreach($id_error['data']['invalid_ids'] as $key => $value) : ?>
                                            <div class="errorlog_row">
                                                <label class="errorlog_report_label"><?php echo $key; ?></label>
                                                <input name="<?php echo $key; ?>" placeholder="<?php echo __("Enter id value for ") . $key?>" class="errorlog_report_result" required/>
                                            </div>
                                        <?php endforeach;
                                    endif; ?>
                                    ...
                                    <?php if(isset($id_error['data']['missing_ids'])):
                                        foreach($id_error['data']['missing_ids'] as $key => $value) : ?>
                                            <div class="errorlog_row">
                                                ...
                                                <input name="<?php echo $value; ?>" placeholder="<?php echo __("Enter id value for ") . $value?>" class="errorlog_report_result" required/>
                                            </div>
                                        <?php endforeach;
                                    endif; ?>
                                </div>
